    ...
    <div className={styles.modal}>
      <div className={styles.modalContent}>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <textarea name="description_ar" value={form.description} onChange={handleChange} required />

          <label>English Description</label>
          <textarea name="description_en" value={form.description} onChange={handleChange} required />
          ...
          {form.has_guide && (
            <>
              ...
              <input name="guide_id" value={form.guide_id} onChange={handleChange} required />
            </>
          )}
